...
if __name__ == '__main__':
	...
	parser.add_argument('-vy', '--youtube-path',
		type=str,
		help='The path to the youtube video')
	...
	elif FLAGS.youtube_path:
		# Read the video
		try:
			url = FLAGS.youtube_path
			print(url)
			video = pafy.new('https://www.youtube.com/watch?v=' + str(url))
